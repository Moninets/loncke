...
get_header(); ?>
    ...
    <main id="fullpage">
        ...
        <div class="section" id="section0">
            <section
                    class="lo-banner full-height align-center align-middle"
                            ...
                            <?php while (has_sub_field('contacts')): ?>
                                <div class="cell medium-4">
                                    ...
                                    <ul class="lo-location__list">
                                        ...
                                        <li class="lo-location__item">
                                            <a href="<?php tel:
                                            the_sub_field('contacts__phone_link') ?>"
                                               class="lo-location__link">
                                                <?php the_sub_field('contacts_phone_text') ?>
                                            </a>
                                        </li>
                                        <li class="lo-location__item">
                                            <a href="<?php the_sub_field('contacts__email'); ?>"
                                               class="lo-location__link">
                                                info@loncke.fr
                                            </a>
                                        </li>
                    ...
                    <?php if ($posts->have_posts()): while ($posts->have_posts()) : $posts->the_post(); ?>
                        <article class="lo-novels__post">
                            ...
                            <?php if ($images): ?>
                                ...
                                <h5 class="lo-novels__post__title">
                                    <?php the_title(); ?>
                                </h5>
                            <?php endif; ?>
                        </article>
